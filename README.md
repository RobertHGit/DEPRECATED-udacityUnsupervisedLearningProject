...
## Scope
In this project I applied unsupervised learning algorithms on two demographic datasets. To identify segments and clusters in the population, and see how customers of a company map to them.

### Project overview (Udacity)
